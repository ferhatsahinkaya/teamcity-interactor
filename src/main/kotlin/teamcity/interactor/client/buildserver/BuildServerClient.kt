...
private data class BuildServerConfig(val baseUrl: String, val waitingBuildsResource: String)
...
val BUILD_SERVER_CLIENT_FACTORY = object : ClientFactory<BuildServerClient> {
    override fun client() =
            Feign.builder()
                    ...
                    .target(BuildServerClient::class.java, "${BUILD_SERVER_CONFIG.baseUrl}${BUILD_SERVER_CONFIG.waitingBuildsResource}")
}
